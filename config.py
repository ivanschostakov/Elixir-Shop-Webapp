...
MOY_SKLAD_ORDER_POSITION_VAT = env_float("MOY_SKLAD_ORDER_POSITION_VAT", 3.0)
MOY_SKLAD_ORDER_POSITION_VAT_ENABLED = env_bool("MOY_SKLAD_ORDER_POSITION_VAT_ENABLED", True)
...
AMOCRM_BASE_URL     = env("AMOCRM_BASE_URL", "https://slimpeptide.amocrm.ru") or "https://slimpeptide.amocrm.ru"
