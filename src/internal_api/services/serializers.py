...
def serialize_user(user: Any, *, enrichment: dict[str, Any] | None = None) -> InternalUserRead | None:
    ...
    payload = {
        ...
        "moysklad_counterparty_id": getattr(user, "moysklad_counterparty_id", None),
    ...
    return InternalCartRead.model_validate(
        {
            ...
            "moysklad_customerorder_id": getattr(cart, "moysklad_customerorder_id", None),
            "moysklad_invoiceout_id": getattr(cart, "moysklad_invoiceout_id", None),
